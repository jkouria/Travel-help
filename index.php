...
<head>
	...
	function initialize(my_lon, my_lat)
	{
		console.log(document.getElementById(my_lon));
		console.log(document.getElementById(my_lat));
		var mapDiv = document.getElementById('googleMap');
  		var mapProp = {
    	center: new google.maps.LatLng(my_lon,my_lat),
    	zoom:9,
...
<form action = "">
  ...
  <div><br>
	...
	<p>
	  ...
	  <input type = "button" value = "Click here to get realtime information" onclick = "loadStations();google.maps.event.addDomListener(document.getElementById('googleMap'), 'load', initialize(document.getElementById('lon'),document.getElementById('lat')));"/>
  </p>
  <div align="center"id="googleMap" style="width:400px;height:300px;"></div>
  <li class="dropdown  style11">
	  <div>
	      <p><img src="img/dg8.gif" name="hr1">
	      	...
	      	<img src="images/dgam.gif" name="ampm">
